...
class Nfc(context: Context) {
    ...
    fun writeBytes(intent: Intent, bytes: ByteArray, mimeType: String, compression: Boolean): Exception? {
        ...
        val newBytes = if (compression) Compression.safeCompress(bytes) else bytes
